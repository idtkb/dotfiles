...
if [ -d $VIMEMU_DIR ]; then
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_copy_cut.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core_ck.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core_disable.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core_emu.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core_lb.xml" $VIMEMU_DIR 
  sudo ln -Fs "${dotfiles}/vim_emu/vim_emu_core_rep.xml" $VIMEMU_DIR 
